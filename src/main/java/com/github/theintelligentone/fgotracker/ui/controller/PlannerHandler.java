...
//    }
//
//    private List<TableColumn<UserServantView, Number>> createColumnsForAllMats() {
//        List<TableColumn<UserServantView, Number>> columns = new ArrayList<>();
//        dataManagementServiceFacade.getMaterials().forEach(mat -> addColumnForMaterial(columns, mat));
//        return columns;
//    }
//
//    private void addColumnForMaterial(List<TableColumn<UserServantView, Number>> columns, UpgradeMaterial mat) {
//        TableColumn<UserServantView, Number> newCol = new TableColumn<>();
...
//    }
//
//    private void resizeIconIfNeeded(UpgradeMaterial mat, TableColumn<UserServantView, Number> newCol, ImageView imageView) {
...
//                    (ListChangeListener<? super UserServantView>) c -> sum.set(
//                            getPlannedMatUseSum((List<UserServantView>) c.getList(), mat)));
...
//    }
//
//    private int getPlannedMatUseSum(List<UserServantView> servants, UpgradeMaterialCostView mat) {
//        return servants.stream()
//                .filter(servant -> servant.baseServantProperty().getValue() != null)
...
//    }
//
//    private ObservableValue<? extends Number> getTotalWidthOfParentColumn(TableColumn<UserServantView, ?> column) {
//        DoubleBinding result = Bindings.createDoubleBinding(() -> (double) 0);
//        for (TableColumn<UserServantView, ?> col : column.getColumns()) {
...
//    }
//
//    private void createContextMenuForPlannerTableRow(TableRow<UserServantView> row) {
//        ContextMenu menu = createBasicPlannerContextMenu();
//        if (PlannerType.LT != plannerElements.getPlannerType()) {
...
//    }
//
//    private List<MenuItem> createEditablePlannerTableMenuItems(TableRow<UserServantView> row) {
...
//                        new UserServantView(), plannerElements.getPlannerType()));
...
//                    i -> dataManagementServiceFacade.savePlannerServant(new UserServantView(),
...
//            TableColumn<UserServantView, Integer> actualCol = (TableColumn<UserServantView, Integer>) col;
...
//                                       Function<TableColumn.CellEditEvent<UserServantView, ?>, IntegerProperty> getProperty,
//                                       int min, int max) {
...
//    }
//
//    private void setCurrentInfoColumnValueFactory(TableColumn<UserServantView, Integer> column,
//                                                  Function<TableColumn.CellDataFeatures<UserServantView, Integer>, IntegerProperty> getProperty) {
...
//    }
//
//    private ObservableList<UserServantView> createLTPlannerServantList() {
