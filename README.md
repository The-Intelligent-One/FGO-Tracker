...
## Quickstart Guide
1. If you have Java 11, download the latest jar, otherwise download the latest release you want and extract, or if you're updating, just grab the exe/jar and replace the old one
2. Run the exe
