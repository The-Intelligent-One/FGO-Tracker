...
//    @Autowired
//    private UserServantToViewTransformer plannerServantToViewTransformer;
//    private ObservableList<UserServantView> plannerServantList;
//    private ObservableList<UserServantView> priorityPlannerServantList;
//
//    public ObservableList<UserServantView> getPaddedPlannerServantList(PlannerType plannerType) {
//        ObservableList<UserServantView> sourceList = getPlannerServantList(plannerType);
//        if (sourceList.size() < MIN_TABLE_SIZE) {
//            IntStream.range(0, MIN_TABLE_SIZE - sourceList.size()).forEach(
//                    i -> sourceList.add(new UserServantView()));
//        }
//        return sourceList;
//    }
//
//    private ObservableList<UserServantView> getPlannerServantList(PlannerType plannerType) {
//        ObservableList<UserServantView> chosenPlannerList;
//        switch (plannerType) {
//            case REGULAR:
...
//    }
//
//    private List<UserServantView> createAssociatedPlannerServantList(List<UserServant> servants,
//                                                                        ObservableList<UserServantView> userServants) {
//        List<UserServantView> plannerServants = plannerServantToViewTransformer.transformAll(
//                servants);
...
//    }
//
//    public void refreshPlannerServants(PlannerType plannerType, List<UserServant> plannerServants,
//                                       ObservableList<UserServantView> userServants) {
